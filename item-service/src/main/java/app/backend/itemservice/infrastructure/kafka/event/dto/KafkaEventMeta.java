package app.backend.itemservice.infrastructure.kafka.event.dto;

import org.apache.kafka.clients.consumer.ConsumerRecord;

import app.backend.itemservice.global.constant.TraceConstants;
import app.backend.itemservice.infrastructure.kafka.constants.KafkaHeaderName;
import app.backend.itemservice.infrastructure.kafka.util.KafkaHeaderUtils;
