package app.backend.itemservice.infrastructure.kafka.message.service;
...
import app.backend.itemservice.infrastructure.kafka.message.repository.ProcessedMessageRepository;
