package app.backend.paymentservice.global.error;
...
import app.backend.paymentservice.global.error.exception.GlobalErrorCode;
...
public class GlobalExceptionHandler {
	...
	private ResponseEntity<ApiResponse<Void>> buildErrorResponse(DomainErrorCode errorCode) {
		...
		return ResponseEntity.status(errorCode.getStatus())
			.header("X-Trace-Id", traceId != null ? traceId : "NO_TRACE")
