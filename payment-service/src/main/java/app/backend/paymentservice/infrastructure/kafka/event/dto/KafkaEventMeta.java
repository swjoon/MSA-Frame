package app.backend.paymentservice.infrastructure.kafka.event.dto;

import org.apache.kafka.clients.consumer.ConsumerRecord;

import app.backend.paymentservice.global.constant.TraceConstants;
import app.backend.paymentservice.infrastructure.kafka.constants.KafkaHeaderName;
import app.backend.paymentservice.infrastructure.kafka.util.KafkaHeaderUtils;
